...
Here we list the related works involving **pseudo-bag concept** or using **pseudo-bags for training**.
...
Please open *a new PR* if you want to add your work in this resource list. 
