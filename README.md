...
| PMIL (TMI'24)      | WSI classification     | [Shapley Values-enabled Progressive Pseudo Bag Augmentation for Whole Slide Image Classification](https://arxiv.org/abs/2312.05490) | [Github](https://github.com/RenaoYan/PMIL)       |   Progressive pseudo-bag augmentation  |
| SWS-MIL (arXiv'24)      | WSI classification     | [MergeUp-augmented Semi-Weakly Supervised Learning for WSI Classification](https://arxiv.org/abs/2408.12825) | -         |   Adaptive pseudo bag augmentation  |
